...
class CesiumBillboard extends BaseGraphic {
  ...
  //   this.graphic.billboard.heightReference=Cesium.HeightReference.NONE
  //   this.updatePosition(new Cesium.Cartesian3(this.position.x,this.position.y,this.position.z+height));
  // }
  stopEdit() {
